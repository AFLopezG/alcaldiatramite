...
class RequisitoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('requisitos')->insert([
            ['detalle'=>'Formulario Único de Solicitud de Tramite del Sistema de Ordenamiento Territorial y Desarrollo Urbano (FORM 001 y FORM 023).','tramite_id'=>11],
            ['detalle'=>'Autorización de Línea y Nivel vigente.','tramite_id'=>11],
            ['detalle'=>'Testimonio de Propiedad y Folio Real debidamente registrado en Derechos Reales (fotocopia visada por la Secretaría Municipal de Asuntos Jurídicos).','tramite_id'=>11],
            ...
            ['detalle'=>'Pago por Tasas y Servicios de las dos últimas gestiones (fotocopia visada por la Secretaría Municipal de Asuntos Jurídicos).','tramite_id'=>11],
            ...
            ['detalle'=>'Planos Arquitectónicos, debidamente firmado por profesional independiente registrado en el colegio correspondiente (con dos copias).','tramite_id'=>11],
            ['detalle'=>'Planos Sanitarios debidamente firmado por profesional independiente registrado en el colegio correspondiente (con dos copias).','tramite_id'=>11],
            ['detalle'=>'Para construcciones iguales o mayores a tres (3) plantas, planos estructurales con estudio de suelo, memoria de cálculo estructural e hidrosanitario, debidamente firmado por profesional independiente registrado en el colegio correspondiente (con dos copias).','tramite_id'=>11],
            ['detalle'=>'Para construcciones iguales o mayores a tres (3) plantas, deberá presentarse Contrato de Obra entre el propietario y el profesional técnico, o persona jurídica debidamente habilitada para el rubro, responsable de la obra.','tramite_id'=>11],
            ['detalle'=>'Para construcciones iguales o mayores a tres (3) plantas, deberá presentarse Contrato de Supervisión entre el propietario y el profesional técnico, o persona jurídica debidamente habilitada para el rubro, responsable de la supervisión de la obra.','tramite_id'=>11],
            ['detalle'=>'Valores Municipales.','tramite_id'=>11],

            ['detalle'=>'Formulario Único de Solicitud de Trámite del Sistema de Ordenamiento Territorial y Desarrollo Urbano (FORM-001 y FORM 023).','tramite_id'=>12],
            ['detalle'=>'Plano Demostrativo en Propiedad Horizontal con corte esquemático (original y fotocopia) firmado por profesional independiente debidamente registrado en el colegio correspondiente.','tramite_id'=>12],
            ['detalle'=>'Testimonio de Propiedad del inmueble con Folio Real y registrado en Derechos Reales, debidamente visado por la Secretaría Municipal de Asuntos Jurídicos del Gobierno Autónomo Municipal Oruro.','tramite_id'=>12],
            ['detalle'=>'Planos arquitectónicos del inmueble, debidamente aprobados por el Gobierno Autónomo Municipal de Oruro.','tramite_id'=>12],
            ['detalle'=>'Testimonio de Propiedad Horizontal del departamento, piso o demás dependencias a ser aprobadas por el Gobierno Autónomo Municipal de Oruro.','tramite_id'=>12],
            ['detalle'=>'Fotocopias del pago de Impuestos a la Propiedad de Bienes Inmuebles y Tasas y Patentes de las dos (12) últimas gestiones, debidamente visadas por la Secretaría Municipal de Asuntos Jurídicos.','tramite_id'=>12],
            ['detalle'=>'Fotocopia de la cédula de identidad del titular','tramite_id'=>12],
            ['detalle'=>'Valores Municipales.','tramite_id'=>12],
...
*/
            ['detalle'=>'Formulario Único de Solicitud de Tramite del Sistema de Ordenamiento Territorial y Desarrollo Urbano (FORM 001 y FOR 023).','tramite_id'=>13],
            ['detalle'=>'Testimonio de propiedad debidamente matriculado en el registro de Derechos Reales (fotocopia visada por la Secretaría Municipal de Asuntos Jurídicos).','tramite_id'=>13],
            ['detalle'=>'Pago de impuestos de la última gestión (fotocopia visada por la Secretaría Municipal de Asuntos Jurídicos).','tramite_id'=>13],
            ['detalle'=>'Pago por Tasas y Servicios de la última gestión (fotocopia visada por la Secretaría Municipal de Asuntos Jurídicos).','tramite_id'=>13],
            ['detalle'=>'Plano demostrativo codificado (original).','tramite_id'=>13],
            ['detalle'=>'Cédula de identidad del titular (fotocopia).','tramite_id'=>13],
            ['detalle'=>'Valores Municipales.','tramite_id'=>13],

            ['detalle'=>'Formulario Único de Solicitud de Tramite del Sistema de Ordenamiento Territorial y Desarrollo Urbano (FORM 001 y FOR 023).','tramite_id'=>14],
            ['detalle'=>'Testimonio de propiedad debidamente matriculado en el registro de Derechos Reales (fotocopia visada por la Secretaría Municipal de Asuntos Jurídicos).','tramite_id'=>14],
            ['detalle'=>'Pago de impuestos de la última gestión (fotocopia visada por la Secretaría Municipal de Asuntos Jurídicos).','tramite_id'=>14],
            ['detalle'=>'Pago por Tasas y Servicios de la última gestión (fotocopia visada por la Secretaría Municipal de Asuntos Jurídicos).','tramite_id'=>14],
            ['detalle'=>'Plano demostrativo codificado (original).','tramite_id'=>14],
            ['detalle'=>'Cédula de identidad del titular (fotocopia).','tramite_id'=>14],
            ['detalle'=>'Valores Municipales.','tramite_id'=>14],

            ['detalle'=>'Formulario de Registro para ingreso de tramite (Form 1)','tramite_id'=>15],
            ['detalle'=>'Formulario de Registro Catasrtal debidamente llenado por profesional Arquitecto independiente legalmente registrado (Form 2)','tramite_id'=>15],
            ['detalle'=>'Hoja Tecnica (Catastro Urbano)','tramite_id'=>15],
            ['detalle'=>'Formulario Control de Documentos (de la Secretaria Municipal de Gestion Territorial) con firma y sello de ventanilla unica y del propietario (Form 3)','tramite_id'=>15],
            ['detalle'=>'Cedula de Identidad del o los titulares (fotocopia)','tramite_id'=>15],
            ['detalle'=>'Fotocopia revisada por Secretaria Municipal de Asuntos Juridicos de Testimonio de Propiedad debidamente registrado en DD.RR. con su folaio real (previo pago de valores conforme a Anexo A)','tramite_id'=>15],
            ['detalle'=>'Fotocopia revisada por Secretaria Municipal de Asuntos juridicos de Pago de Impuestos y Tasas por Servicios de la ultima gestion','tramite_id'=>15],
            ['detalle'=>'Original de Linea Nivel con una antigüedad maxima de dos años','tramite_id'=>15],
            ['detalle'=>'Original de Plano Demostrativo Codificado, no mayor a cinco años','tramite_id'=>15],
            ['detalle'=>'Planos Arquitectonicos de la construccion AS-BUILT (plano real de la obra ejecutada) en formato digital (CD) un original y dos copias en papel bond (de conformidad al procedimiento), elaborado por el profesional Arquitecto legalmente registrado, con numero de registro profesional. En caso de ampliacion de la construccion, cumplir lo establecido en el inciso C del articulo 10 del presente reglamento','tramite_id'=>15],
            ['detalle'=>'Planos de Instalacion Sanitaria firmado por profesional Ingeniero Civil independiente, quien se constituye en responsable del mismo, debidamente registrado en el colegio correspondiente','tramite_id'=>15],
            ['detalle'=>'Certificacion de Estabilidad Estructural de la construccion firmado por el profesional Ingeniero Civil independiente, quien se constituye en responsable del mismo, debidamente registrado en el colegio correspondiente, en cumplimiento a lo establecido en el inciso A del articulo 17 del presente reglamento','tramite_id'=>15],
            ['detalle'=>'Certificacion de Instalacion Electrica firmado por el profesional Ingeniero Electrico independiente, quien se constituye en responsable del mismo, debidamente registrado en el colegio correspondiente, en cumplimiento a lo establecido en el inciso B del articulo 17 del presente reglamento','tramite_id'=>15],
            ['detalle'=>'Valores Municipales previsto en la normativa municipal vigente','tramite_id'=>15],
